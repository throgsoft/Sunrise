...
[[nodiscard]] std::uint16_t mote_ownership_mask(
    std::span<const account::inventory::ProfileItem> rows) noexcept;
...
[[nodiscard]] std::uint16_t mote_publication_mask(
    std::span<const account::inventory::ProfileItem> rows,
...
[[nodiscard]] bool project_exchange(
    const PendingSocketPlug& mutation,
...
[[nodiscard]] bool mote_ownership_changed(std::span<const account::inventory::ProfileItem> before,
