...
enum class Category : std::uint8_t {
    all, bounties, engrams, weapons, armor, consumables, materials, cosmetics, dummies, other
};
inline constexpr std::array<const char*, 10> kCategoryNames{
    "All", "Bounties", "Engrams", "Weapons", "Armor", "Consumables", "Materials", "Cosmetics", "Dummies", "Other"};
struct Objective {
    std::uint16_t index{};
    std::uint32_t hash{};
...
struct Entry {
    ...
    std::string name{}, description{}, itemType{}, grantVariant{}, search{};
