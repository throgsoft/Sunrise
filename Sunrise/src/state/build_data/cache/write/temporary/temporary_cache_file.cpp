...
[[nodiscard]] WriteStatus write_file(const wchar_t* temporaryPath,
    ...
    const records::Header header{
        ...
        static_cast<std::uint32_t>(domains.exoticCatalysts.size()),
        ...
        static_cast<std::uint32_t>(domains.recordObjectives.size()),
        static_cast<std::uint32_t>(domains.recordIntervals.size()),
        static_cast<std::uint32_t>(domains.recordRewards.size()),
        static_cast<std::uint32_t>(domains.progressionSteps.size()),
        static_cast<std::uint32_t>(domains.seasonPassRewards.size()),
        static_cast<std::uint32_t>(domains.bounties.size()),
        static_cast<std::uint32_t>(domains.rewardPools.size()),
        static_cast<std::uint32_t>(domains.rewardEntries.size()),
        static_cast<std::uint32_t>(domains.rewardItems.size()),
        static_cast<std::uint32_t>(domains.rewardInstructions.size()),
        static_cast<std::uint32_t>(domains.rewardModifiers.size()),
        static_cast<std::uint32_t>(domains.rewardSockets.size()),
